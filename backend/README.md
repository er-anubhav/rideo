# Rideshare Backend - Complete Documentation
...
A complete monolithic backend for a ride-sharing application built with **Python/FastAPI**. Supports riders, drivers, and administrators with real-time tracking, fare calculation, and push notifications.
